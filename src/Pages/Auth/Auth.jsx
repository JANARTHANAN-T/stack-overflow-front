...
const Auth = () => {
  ...
  const verify =(e) =>{
    ...
    if(isSignup){
        ...
        dispatch(signup({name,email,password,mobile},navigate))
        
    }else{
        dispatch(login({mobile},navigate))
    }
  }
        ...
        <form onSubmit={handleSubmit}>
          ...
          <label htmlFor='phone'>
            ...
            {/* <label htmlFor="password">
                ...
                <div>
                <input style={{width:"100%"}}  type="password" name='password' id='password' value={password} onChange={(e) => {setPassword(e.target.value)}}/>
